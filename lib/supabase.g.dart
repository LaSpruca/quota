...
StoredData _$StoredDataFromJson(Map<String, dynamic> json) => StoredData(
      ...
      needsRemoving: (json['needsRemoving'] as List<dynamic>)
          .map((e) => Quote.fromJson(e as Map<String, dynamic>))
          .toList(),
      needsAdding: (json['needsAdding'] as List<dynamic>)
          .map((e) => NewQuote.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$StoredDataToJson(StoredData instance) =>
    <String, dynamic>{
